...
import {
  ...
  externalLeadInitSchema,
  externalLeadProgressSchema,
  getLeadParamsSchema,
...
import {
  ...
  stageDurationQuerySchema,
  timeseriesQuerySchema,
} from "./core/leadsAnalytics.schema.js";
...
export const schemas = Object.freeze({
  ...
  leadActivity: {
    ...
    updateEmail: updateActivityEmailSchema,
  },
  leadContact: {
  ...
  lead: {
    ...
    search: leadSearchQuerySchema,
    external_website_lead_init: externalLeadInitSchema,
    external_website_lead_progress: externalLeadProgressSchema,
  },
  leadAnalytics: {
    overview: overviewQuerySchema,
    funnel: funnelQuerySchema,
    users: usersQuerySchema,
    scoreboard: scoreboardQuerySchema,
    activities: activitiesQuerySchema,
    stageDuration: stageDurationQuerySchema,
    timeseries: timeseriesQuerySchema,
  },
});
