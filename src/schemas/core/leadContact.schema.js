...
export const createLeadContactSchema = z
  .object({
    entity_type: z.enum([
      "INDIVIDUAL",
      "UN_REGISTRED",
    ...
    primary_phone: z.string().trim().min(7).max(20).optional(),
...
const updateLeadContactSchema = createLeadContactSchema.partial();

/* ID */

const leadContactIdSchema = z.object({
  id: z.string().uuid(),
});

/* LIST */
const listLeadContactSchema = z.object({
  page: z
    .string()
  ...
  entity_type: createLeadContactSchema.shape.entity_type.optional(),

  industry: createLeadContactSchema.shape.industry.optional(),
  ...
  preferred_language:
    createLeadContactSchema.shape.preferred_language.optional(),
