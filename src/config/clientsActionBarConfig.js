...
// Helper function to create additionalActions with bulk import
export const createClientsActionBarConfig = (onBulkImport) => ({
  config: {
    entityName: "Client",
  ...
  // Additional actions array with bulk import button
  additionalActions: [
    {
      label: "Bulk Import",
      icon: Upload,
      onClick: onBulkImport,
      className: "generic-ab__bulk-import-btn",
      title: "Import multiple clients from Excel",
      disabled: false,
    },
  ],
});

// Static config (for backward compatibility, but won't have bulk import button)
