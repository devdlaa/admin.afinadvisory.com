...
export default function CreateLeadDrawer({
  ...
  const handleContactConfirm = (payload) => {
    if (payload.type === "__cleared") {
      ...
      setLinkedContact({
        id: payload.id,
        contact_person: payload.displayName,
        displayMeta: payload.displayMeta,
        primary_email: payload.displayMeta?.split(" • ")[1] || "",
      });
  ...
  const handleReferenceConfirm = (payload) => {
    if (payload.type === "__cleared") {
      ...
      setLinkedReference({
        ...
        _display: { name: payload.displayName, meta: payload.displayMeta },
      });
  ...
  const contactSelectedData = linkedContact
    ? {
        __type: "lead_contact",
        id: linkedContact.id,
        displayName: linkedContact.contact_person,
        displayMeta: [
  ...
  const referenceSelectedData = linkedReference
    ? {
        ...
        displayName: refDisplay?.name,
        displayMeta: refDisplay?.meta,
        ...(linkedReference.type === "EXTERNAL_PERSON" && {
          name: linkedReference.name,
          email: linkedReference.email,
          phone: linkedReference.phone,
        }),
      }
    : null;
            ...
            >
              {linkedContact ? (
                <LinkedPill
                  ...
                  meta={linkedContact.displayMeta}
      ...
      <LinkSelectionDialog
        ...
        tabs={[
          ...
          },
          {
            ...
            results: infResults.map((e) => ({
              ...e,
              displayName: e.name,
              displayMeta: [e.email, e.phone].filter(Boolean).join(" • "),
            })),
            isSearching: infSearching,
          },
          {
            id: "external",
            label: "External Ref",
