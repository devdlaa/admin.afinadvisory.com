...
import ReferenceSection from "./components/LeadReferenceSection";
...
export default function LeadDetailsDrawer({
  ...
  const selectedContactData = lead?.contact
    ? {
        __type: "lead_contact",
        id: lead.contact.id,
        displayName: lead.contact.contact_person || lead.contact.name,
        displayMeta: [
          lead.contact.entity_type?.replaceAll("_", " "),
          lead.contact.primary_email || lead.contact.email,
  ...
  const selectedReferenceData = (() => {
    ...
    if (ref.type === "LEAD_CONTACT") {
      return {
        ...
        displayName: ref.contact_person || ref.name,
        displayMeta: [ref.email, ref.phone].filter(Boolean).join(" • "),
        typeLabel: "LEAD CONTACT",
        email: ref.email,
        phone: ref.phone,
      };
    }
          ...
          <div className={styles.body}>
            ...
            <div className={styles.leftPanel} ref={leftPanelRef}>
              ...
              <ReferenceSection
                ...
                onUpdate={() => setIsReferenceDialogOpen(true)}
                sectionLabel="LEAD REFERENCE"
              />
          ...
          tabs={[
            {
              ...
              results: contactResults.map((e) => ({
                ...e,
                displayName: e.contact_person || e.name,
                displayMeta: [
        ...
        <LinkSelectionDialog
          ...
          tabs={[
            ...
            },
            {
              ...
              results: influencerResults.map((e) => ({
                ...e,
                displayName: e.name,
                displayMeta: [e.email, e.phone].filter(Boolean).join(" • "),
              })),
              isSearching: influencerSearching,
            },
            {
              id: "external",
              label: "External Ref",
