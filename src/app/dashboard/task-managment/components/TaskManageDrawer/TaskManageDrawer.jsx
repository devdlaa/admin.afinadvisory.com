...
import LinkSelectionDialog from "@/app/dashboard/leads-manager/components/LinkSelectionDialog/LinkSelectionDialog";
import ReferenceSection from "@/app/dashboard/leads-manager/components/LeadDetailsDrawer/components/LeadReferenceSection";
  ...
  return (
    <>
          ...
          <div className="task-drawer__body">
            ...
            <div className="task-drawer__right">
              ...
              <ReferenceSection
                ...
                onUpdate={() => setShowReferenceDialog(true)}
                sectionLabel="TASK REFERENCE"
              />
      ...
      <LinkSelectionDialog
        ...
        onSearchChange={handleReferenceSearch}
        onTabChange={handleReferenceTabChange}
