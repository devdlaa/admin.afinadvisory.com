...
const TaskActionBar = ({
  ...
  onShowReferenceFilter,
  isReferenceFilterOpen = false,
  isReferenceFilterActive = false,
  ...
  const slaLabel = hasSLAFilterActive ? "SLA Active" : "SLA";
  ...
  const referencePillModifier = isReferenceFilterActive
    ? "task-action-bar__sla-pill--filter-active"
    : isReferenceFilterOpen
      ? "task-action-bar__sla-pill--active"
      : "";

  const referencePillClass = [
    "task-action-bar__sla-pill",
    referencePillModifier,
  ]
    .filter(Boolean)
    .join(" ");

  const referenceLabel = isReferenceFilterActive
    ? "Reference Active"
    : "Reference";

  const referenceTitle = isReferenceFilterActive
    ? "Reference filter is applied — click to manage"
    : "Filter tasks by referral source";
