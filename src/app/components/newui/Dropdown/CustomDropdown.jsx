...
const CustomDropdown = ({
  ...
  outlineColor = "",
  bgColor = "",
  className = "", // Root class for user overrides
  maxHeight = null, // Custom max height for dropdown
    ...
    <div className={dropdownClasses} ref={dropdownRef}>
      ...
      >
        ...
        {isLoading ? (
          ...
          showDropdownArrow && <ChevronDown className={styles.chevron} />
        )}
      </button>
        ...
        >
          ...
          {onAddNew && (
            <div className={styles.addNewContainer}>
              ...
              >
                {isAddingNew ? (
                  <Loader2 className={styles.addNewLoader} />
                ) : (
