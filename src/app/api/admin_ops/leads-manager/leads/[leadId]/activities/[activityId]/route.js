...
export async function GET(request, { params }) {
  try {
    const [permissionError,session,admin_user] = await requirePermission(request, "leads.access");
    ...
    const result = await getLeadActivityDetails(parsed.params.id,admin_user);
