// app/api/task-categories/route.js
...
export async function POST(request) {
  try {
    ...
    // Create category
    const category = await createTaskCategory(validatedData);
...
// GET - List all task categories with pagination and filters
export async function GET(request) {
  try {
    ...
    // Get categories
    const result = await listTaskCategories(validatedParams);
