...
export const formatDuration = (ms) => {
  ...
  if (days > 0)
    return `Lead  Stuck In this stage for last ${days} d ${hours} h`;
  if (hours > 0) return `In this stage for last ${hours} h ${minutes} m`;
  return `Just Entred  ${minutes} minutes Ago`;
};
